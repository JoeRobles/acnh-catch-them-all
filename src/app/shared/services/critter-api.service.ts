...
export class CritterApiService {
  ...
  getBugs(): Observable<BugModel[]> {
    return this.http.get<BugResponseInterface[]>(`${this.apiUrl}/bugs`)
      .pipe(
  ...
  getBugModels(): Observable<BugModelModel[]> {
    return this.http.get<ModelResponseInterface[]>(`${this.apiUrl}/bug-models`)
      .pipe(
  ...
  getFish(): Observable<FishModel[]> {
    return this.http.get<FishResponseInterface[]>(`${this.apiUrl}/fish`)
      .pipe(
  ...
  getFishModels(): Observable<FishModelModel[]> {
    return this.http.get<ModelResponseInterface[]>(`${this.apiUrl}/fish-models`)
      .pipe(
  ...
  getSea(): Observable<SeaModel[]> {
    return this.http.get<SeaResponseInterface[]>(`${this.apiUrl}/sea`)
      .pipe(
  ...
  getSongs(): Observable<SongModel[]> {
    return this.http.get<SongResponseInterface[]>(`${this.apiUrl}/songs`)
      .pipe(
  ...
  getFossils(): Observable<FossilModel[]> {
    return this.http.get<FossilResponseInterface[]>(`${this.apiUrl}/fossils`)
      .pipe(
  ...
  getArt(): Observable<ArtModel[]> {
    return this.http.get<ArtResponseInterface[]>(`${this.apiUrl}/art`)
      .pipe(
  ...
  getMusic(): Observable<MusicModel[]> {
    return this.http.get<MusicResponseInterface[]>(`${this.apiUrl}/hourly`)
      .pipe(
